...
public class BundlerInputFormat extends FileInputFormat<IntWritable, TextArrayWritable> {

	@Override
	public RecordReader<IntWritable, TextArrayWritable> createRecordReader(InputSplit split, TaskAttemptContext context)
