package mosab.process.downloader;
 ...
 * /home/mosab/Desktop/fileList.txt /home/mosab/Desktop/output.hib 10
 * 
 * <br />
 ...
 *
 */
public class DownloaderFileList extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 3) {
			System.out.println(
					"Usage: downloader <input text file with list of files paths> <output HIB> <number of download nodes>");
			System.exit(0);
		}
		...
		job.setJarByClass(DownloaderFileList.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int res = ToolRunner.run(conf, new DownloaderFileList(), args);
		System.exit(res);
	}
}
