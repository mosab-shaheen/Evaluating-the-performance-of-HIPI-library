 ...
 * /home/mosab/Desktop/test/files.txt /home/mosab/Desktop/test/output/output.hib 10
 * 
 * <br />
...
public class Downloader extends Configured implements Tool {
	...
	// Setup to time download
	  ...
	  // Attempt to download image at URL using java.net
          try {
            ...
            java.nio.file.Path path = Paths.get(fpath);  
  ...
  public int run(String[] args) throws Exception {
    ...
    if (args.length != 3) {
      System.out.println("Usage: downloader <input text file with list of files paths> <output HIB> <number of download nodes>");
      System.exit(0);
    }
